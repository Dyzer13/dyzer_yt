...
const fs = require("fs");// npm i fs
      ...
      const welcomer =  member.guild.channels.find('name', 'welcome-memebers');//اسم الروم الي يرحب فيه
                  ...
                  ctx.drawImage(ground, 0, 0, 401, 202);
                      ...
                      jimp.read(url, (err, ava) => {
                          ...
                          ava.getBuffer(jimp.MIME_PNG, (err, buf) => {
                              ...
                              let ava = new Avatar;
                              ava.src = buf;
                              ctx.drawImage(ava, 152, 27, 95, 95);const Discord = require('discord.js');
...
Server support: https://discord.gg/gQeFJ8J

bot invite link: https://discordapp.com/api/oauth2/authorize?client_id=454793806206730260&permissions=2146958583&scope=bot
...
bot.login("NDU0NzkzODA2MjA2NzMwMjYw.DfypiQ.pPtOeGzrDYOdFNgRUIQFQMT0Roo");
